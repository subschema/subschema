...
describe('components/RenderContent', function () {
    function ctx(Type, {valueManager, loader, injector} = newSubschemaContext()) {
        const IType = injector.inject(Type);
        loader.addType("Content", Content);
        return class extends Component {
            static displayName = 'Context';
            static childContextTypes = PropTypes.contextTypes;

            getChildContext() {
                return {valueManager, loader, injector};
            }
    ...
    describe('tests', function () {
        Object.keys(tests).forEach(function (key) {
            ...
            it(`should render ${JSON.stringify(test)}`, function () {
                ...
                const IContent = ctx(Content, newSubschemaContext({valueManager}));
