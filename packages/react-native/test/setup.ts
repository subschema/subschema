...
vi.mock('react-native', () => {
  ...
  // Text → span
  RN.Text = React.forwardRef(({ className, accessibilityRole, testID, ...props }: any, ref: any) => {
  ...
  RN.TextInput = React.forwardRef(
    ({ className, onChangeText, editable, testID, secureTextEntry, keyboardType, autoCapitalize, ...props }: any, ref: any) =>
      React.createElement('input', {
        ...
        onChange: onChangeText
          ? (e: any) => onChangeText(e.target.value)
          : undefined,
      }),
  );
  ...
  // Pressable → button
  RN.Pressable = React.forwardRef(({ className, onPress, testID, disabled, ...props }: any, ref: any) =>
  ...
  RN.FlatList = React.forwardRef(({ data, renderItem, keyExtractor, className, testID, ...props }: any, ref: any) =>
    React.createElement(
      'div',
  ...
  RN.Modal = ({ visible, children, transparent, animationType, ...props }: any) => {
    ...
    return React.createElement('div', { 'data-testid': 'modal', role: 'dialog', ...props }, children);
  };
  (RN.Modal as any).displayName = 'Modal';

  // Switch → input[type=checkbox]
  RN.Switch = React.forwardRef(({ value, onValueChange, testID, disabled, ...props }: any, ref: any) =>
    React.createElement('input', {
      type: 'checkbox',
      checked: !!value,
      'data-testid': testID,
