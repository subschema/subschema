...
<div class="space-y-8">
  <div>
    ...
    <p class="mt-2 text-sm text-gray-500 dark:text-gray-500">
      The <code class="rounded bg-gray-100 px-1 dark:bg-gray-800">Rating</code> field is a
      custom component passed via
      <code class="rounded bg-gray-100 px-1 dark:bg-gray-800">{'<Form types={{ Rating: RatingField }}>'}</code>
    </p>
  </div>
