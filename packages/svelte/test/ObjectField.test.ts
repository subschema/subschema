...
describe('Nested ObjectField with child container', () => {
  it('renders nested form fields inside a card', async () => {
    render(Form, { props: { schema: nestedSchema } });
    await tick();
  ...
  it('renders the object title as card header', async () => {
    render(Form, { props: { schema: nestedSchema } });
    await tick();
  ...
  it('renders deeply nested object schemas', async () => {
    ...
    render(Form, { props: { schema: deepSchema } });
    await tick();
