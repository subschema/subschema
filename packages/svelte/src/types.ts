...
// ──────────────────────────────────────────────
// Svelte-specific registry & component types
// ──────────────────────────────────────────────
...
/** A Svelte component that renders a form field */
export type FieldComponent = Component<FieldComponentProps>;
...
/** A Svelte component that wraps a field with label, error, etc. */
export type TemplateComponent = Component<TemplateComponentProps>;
