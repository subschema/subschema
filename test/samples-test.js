...
import Subschema, {ValueManager as OrigValueManager,FastValueManager, newSubschemaContext} from 'subschema';

describe('samples', function () {
    [OrigValueManager, FastValueManager].forEach(function (ValueManager) {
        describe(`Using, ${ValueManager.name}`, function () {
            if (console.time) {
                before(function () {
